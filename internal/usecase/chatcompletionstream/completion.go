...
import (
	...
	"github.com/matheuszanatta/chatservice/internal/domain/entity"
	"github.com/matheuszanatta/chatservice/internal/domain/gateway"
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		if err.Error() == "chat not found" {
			...
			if err != nil {
				return nil, errors.New("eror creating new chat: " + err.Error())
			}
			// save on database
